...
// const z = users.map(u => {return  {email: u.email ,company:  u.company.name}  } )
// console.log(z)
...
//     const org = vegetables.filter(v => v.color==="orange")
//     console.log(org)
...
// const performance = function(person){
...
//  const arr = messagesFromDad.map(m=> m.toLowerCase())
